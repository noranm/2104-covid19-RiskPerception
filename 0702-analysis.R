...
fit1 <- glm(Anxiety~ TrustApproval + TrustNeutral + TrustNoOp + 
                 ...
                 Phase2 + Phase3 + Phase4 + Phase5, data=risk_base_2, weights=risk_base_2$WT2, family="binomial")
...
file_format <- file('./[210702]Overall.csv',encoding="euc-kr")
...
for (i in phase){
  ...
  fit <- glm(Anxiety~ TrustApproval + TrustNeutral + TrustNoOp + 
               ...
               Middle + LowerMiddle + 
               Chung + Yeong + Ho +AreaETC +
               PoliticalLiberal + PoliticalNeutral + PoliticalNoOp, data=each.Surv, weights=each.Surv$WT2, family="binomial")
...
file_format <- file('./[210702]eachPhase_Affective.csv',encoding="UTF-8")
...
file_format <- file('./[210702]eachPhase_Cognitive.csv',encoding="UTF-8")
